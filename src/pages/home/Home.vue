<template>
  <div>
    <home-header
      @changeCreateShow="changeCreateShow"
    ...
    <login
      :isShow="loginShow"
      @changeLoginNone="changeLoginNone"
...
import {
  ...
  getNineAnnouncement,
  getNineGoodthings,
  getNinePublicconnects,
  getNincePublicActivitys,
} from "apis/list"; //引入基本的post和get方法
...
export default {
  ...
  methods: {
    ...
    putDbn(list, dbNumber) {
      //list是传入的数组，number是需要赋值的dbn
